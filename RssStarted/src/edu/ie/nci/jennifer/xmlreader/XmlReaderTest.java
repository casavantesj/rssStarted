...
public class XmlReaderTest {
	...
	public void test() {
		...
		assertEquals("/home/jennifer/workspace/RssStarted/src/test.xml file loaded, not parsed", reader.toString());
		assertNotNull(reader.getFile());
		Configuration configuration = reader.parse();
		assertEquals("/home/jennifer/workspace/RssStarted/src/test.xml file loaded, parsed", reader.toString());
		...
		assertNotEquals("John, mary, jennifer", configuration.getOwner());
	}
